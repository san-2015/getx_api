...
class DetailPage extends GetView<DataController> {
  ...
  Widget build(BuildContext context) {
    ...
    if (id == null || id.isEmpty || int.tryParse(id) == null) {
      print("Invalid ID received  $id");
      return Container(); // prevents further execution
    }
    final index = int.parse(id!);
    final dataModel = controller.dataList[index];

    // final DataController controller = Get.find<DataController>(); for statelesss widget class
    // final DetailDataModel dataModel = Get.arguments as DetailDataModel;
    return Scaffold(
      appBar: AppBar(
